  ...
  const services = [
    {
      icon: 'Code2',
      title: 'Разработка ПО',
      description: 'Создание высоконагруженных систем, веб-приложений и мобильных решений с использованием современных технологий'
    },
    {
      icon: 'Database',
      title: 'Внедрение систем',
      description: 'Проектирование и интеграция корпоративных информационных систем, CRM, ERP и других бизнес-решений'
    },
    {
      icon: 'Cpu',
      title: 'Автоматизация процессов',
      description: 'Оптимизация бизнес-процессов через автоматизацию рутинных операций и внедрение RPA-решений'
    },
    {
      icon: 'Cloud',
      title: 'Облачные решения',
      description: 'Миграция инфраструктуры в облако, разработка облачных архитектур и DevOps-практик'
    },
    {
      icon: 'ShieldCheck',
      title: 'Информационная безопасность',
      description: 'Аудит безопасности, внедрение защитных механизмов и обеспечение соответствия стандартам'
    },
    {
      icon: 'Sparkles',
      title: 'AI и машинное обучение',
      description: 'Разработка интеллектуальных систем, внедрение AI-решений для анализа данных и автоматизации'
    }
  ];
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-primary-foreground/80">
                <div>Разработка ПО</div>
                <div>Внедрение систем</div>
                <div>Автоматизация процессов</div>
              </div>
            </div>
            <div className="space-y-4">
